      ...
      <div className="grid w-full max-w-lg grid-cols-2 gap-3">
        {SUGGESTED_QUESTIONS.map((q, i) => (
          <button
            ...
            className="cursor-pointer rounded-lg border p-3 text-left text-sm leading-snug transition-colors duration-150 hover:border-[var(--accent)] hover:bg-[var(--surface)]"
            style={{
              background: "var(--card)",
